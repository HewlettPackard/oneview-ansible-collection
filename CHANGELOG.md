...
## v11.4.0
This release extends the planned support of the collections to OneView REST API version 8800 (OneView v11.4).
...
## v11.3.0
This release extends the planned support of the collections to OneView REST API version 8600 (OneView v11.3).
...
## v11.2.0
This release extends the planned support of the collections to OneView REST API version 8400 (OneView v11.2).
...
## v10.2.0
This release extends the planned support of the collections to OneView REST API version 8000 (OneView v10.2).
...
## v10.1.0
This release extends the planned support of the collections to OneView REST API version 7800 (OneView v10.1).
...
## v10.0.0
This release extends the planned support of the collections to OneView REST API version 7600 (OneView v10.0).
...
## v9.4.0
This release extends the planned support of the collections to OneView REST API version 7400(OneView v9.4).
...
## v9.3.0
This release extends the planned support of the collections to OneView REST API version 7200(OneView v9.3).
...
## v9.2.0
This release extends the planned support of the collections to OneView REST API version 7000(OneView v9.2).
...
## v9.1.0
This release extends the planned support of the collections to OneView REST API version 6800(OneView v9.1).
