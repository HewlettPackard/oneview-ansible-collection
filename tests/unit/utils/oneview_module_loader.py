...
from ansible_collections.hpe.oneview.plugins.modules.oneview_appliance_network_interfaces import ApplianceNetworkInterfacesModule
from ansible_collections.hpe.oneview.plugins.modules.oneview_appliance_network_interface_facts import ApplianceNetworkInterfaceFactsModule
from ansible_collections.hpe.oneview.plugins.modules.oneview_appliance_proxy_configuration import ApplianceProxyConfigurationModule
from ansible_collections.hpe.oneview.plugins.modules.oneview_appliance_proxy_configuration_facts import ApplianceProxyConfigurationFactsModule
...
from ansible_collections.hpe.oneview.plugins.modules.oneview_id_pools import IdPoolsModule
from ansible_collections.hpe.oneview.plugins.modules.oneview_id_pools_facts import IdPoolsFactsModule
...
from ansible_collections.hpe.oneview.plugins.modules.oneview_rack_manager import RackManagerModule
from ansible_collections.hpe.oneview.plugins.modules.oneview_rack_manager_facts import RackManagerFactsModule
...
from ansible_collections.hpe.oneview.plugins.modules.oneview_logout_session import LogoutSessionModule
...
imports = [
    ...
    ServerProfileMerger,
    ServerProfileReplaceNamesByUris,
    ApplianceConfigurationTimeconfigFactsModule,
    ApplianceNetworkInterfacesModule,
    _str_sorted,
    compare,
    get_logger,
    merge_list_by_key,
    transform_list_to_dict,
    ApplianceDeviceSnmpV1TrapDestinationsFactsModule,
    ApplianceDeviceSnmpV1TrapDestinationsModule,
    ApplianceDeviceSnmpV3TrapDestinationsModule,
    ApplianceDeviceSnmpV3TrapDestinationsFactsModule,
    ApplianceDeviceSnmpV3UsersModule,
    ApplianceDeviceSnmpV3UsersFactsModule,
    ApplianceNetworkInterfaceFactsModule,
    ApplianceProxyConfigurationModule,
    ApplianceProxyConfigurationFactsModule,
    ApplianceSshAccessFactsModule,
    ApplianceSshAccessModule,
    ApplianceTimeAndLocaleConfigurationFactsModule,
    ApplianceTimeAndLocaleConfigurationModule,
    CertificatesServerModule,
    CertificatesServerFactsModule,
    ...
    HypervisorClusterProfileModule,
    HypervisorClusterProfileFactsModule,
    HypervisorManagerModule,
    HypervisorManagerFactsModule,
    IdPoolsModule,
    IdPoolsFactsModule,
    IdPoolsIpv4SubnetModule,
    IdPoolsIpv4SubnetFactsModule,
    InterconnectModule,
    ...
    ScopeModule,
    ScopeFactsModule,
    RepositoriesFactsModule,
    RepositoriesModule,
    RackManagerModule,
    RackManagerFactsModule,
    ...
    UserFactsModule,
    VolumeModule,
    IdPoolsIpv4RangeModule,
    IdPoolsIpv4RangeFactsModule,
    GetSessionIDModule
]
