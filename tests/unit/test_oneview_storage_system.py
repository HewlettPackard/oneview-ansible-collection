...
from ansible_collections.hpe.oneview.tests.unit.utils.oneview_module_loader import StorageSystemModule
...
DICT_DEFAULT_STORAGE_SYSTEM_500 = yaml.safe_load(YAML_STORAGE_SYSTEM_500)["data"]
